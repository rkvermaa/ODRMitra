/**
 * ODRMitra Baileys WhatsApp Service
 *
 * Provides API for:
...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', service: 'odrmitra-baileys' });
});
...
app.listen(config.port, () => {
  logger.info(`ODRMitra Baileys WhatsApp Service running on port ${config.port}`);
  ...
  setTimeout(async () => {
    logger.info('Auto-restoring saved WhatsApp sessions...');
