/**
 * Session Manager - Handles per-user WhatsApp sessions for ODRMitra
 */
...
export async function startSession(userId) {
  ...
  const socket = makeWASocket({
    ...
    browser: ['ODRMitra', 'Chrome', '120.0.6099'],
 ...
 * Called on service startup to reconnect previously authenticated sessions.
 */
